...
- Khởi động [Microsoft MakeCode](https://makecode.microbit.org/) và **Import** chương trình theo đường link sau: [https://github.com/makereduvn/mke_m01_1_led_microbit/](https://github.com/makereduvn/mke_m01_1_led_microbit/)
- Kết nối mạch Micro:bit và nạp (Download) chương trình.
- Cấp nguồn 5VDC cho mạch, kết nối chân SIG của module với chân điều khiển được khai báo trong chương trình.
- Xem kết quả mạch hoạt động theo chương trình đã nạp.
